...
if(file_exist(trim(src_file), no_domain=.true.)) then
...
if (.not. file_exist("INPUT/aerosol.climatology.nc", no_domain=.true.) ) return
...
if (.not. file_exist("INPUT/o3.climatology.nc", no_domain=.true.) ) return
