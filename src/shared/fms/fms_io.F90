...
logical           :: checksum_required   = .false.!.true.                !stg
...
character(len=128) :: version = '$Id: fms_io.F90,v 21.0 2014/12/15 22:13:23 fms Exp $'
...
!-----------------------------------------------------------------------
 ...
 subroutine get_tile_string(str_out, str_in, tile, str2_in)
  ...
  function get_file_name(orig_file, actual_file, read_dist, io_domain_exist, no_domain, domain, &
    ...
    type(domain2d), pointer       :: d_ptr=>NULL(), io_domain=>NULL()      !z1l 3/9/15
