...
!
!-----------------------------------------------------------------------
  character(len=128) :: version = '$Id: coupler_types.F90,v 21.0 2014/12/15 22:12:11 fms Exp $'
...
outunit = stdout()
!stg write (outunit,*)
!stg write (outunit,*) 'Dumping coupler_mod/types tree'
!stg if (.not. fm_dump_list('/coupler_mod/types', recursive = .true.)) then  !{
!stg   call mpp_error(FATAL, trim(error_header) // ' Problem dumping /coupler_mod/types tree')
!stg endif  !}
