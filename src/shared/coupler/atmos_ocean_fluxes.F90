...
character(len=128) :: version = '$Id: atmos_ocean_fluxes.F90,v 21.0 2014/12/15 22:12:08 fms Exp $'
...
outunit = stdout()
!stg write (outunit,*)
!stg write (outunit,*) trim(note_header), ' Processing coupler fluxes ', trim(name)
...
!stg write (outunit,*)
!stg write (outunit,*) 'Dumping fluxes tracer tree'
